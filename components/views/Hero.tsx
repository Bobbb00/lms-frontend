...
import redpanda from "@/public/redpanda.jpg";

export default function Hero() {
    return (
        <section className="container mx-auto py-12 lg:py-20 px-6 lg:px-10 flex flex-col lg:flex-row items-center gap-10">
            <div className="lg:w-1/2 space-y-6 text-center text-left">
                <Badge variant="secondary" className="bg-blue-950 text-primary font-bold hover:bg-blue-900 mb-4 rounded-lg px-3 py-1">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4">
                    ...
                    <Button variant="secondary" className="bg-slate-800 hover:bg-slate-700 text-white font-bold text-lg py-6 px-8 rounded-lg border border-slate-700">
                        View Roadmaps
                    </Button>
                </div>
            </div>
            ...
            <div className="lg:w-1/2 w-full mt-10 lg:mt-0 relative">
                <div className="relative rounded-xl overflow-hidden ">
                    <Image
                        ...
                        src={redpanda} // Sementara pakai redpanda sampai ada aset asli
